...
import numpy as np
from emlp.solver.representation import T,Scalar,Vector,Matrix,Quad,size
from emlp.solver.representation import capped_tensor_ids,rep_permutation,bilinear_weights
from emlp.solver.groups import LearnedGroup
from emlp.models.batchnorm import TensorMaskBN,gate_indices,MaskBN
import collections
...
from emlp.models.mlp import Sequential
