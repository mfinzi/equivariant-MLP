...
def makeTrainer(*,dataset=DoubleSpringPendulum,network=MLPode,num_epochs=2000,ndata=5000,seed=2021,aug=False,
                ...
                net_config={'num_layers':3,'ch':128,'group':O2eR3()},log_level='error',
...
if __name__ == "__main__":
    ...
    #config_spec = argupdated_config(config_spec,namespace=(emlp.solver.groups,emlp.models.datasets,emlp.models.mlp))
